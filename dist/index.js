...
var Reconciler = reactReconciler_production_min({
...
function Scene(props) {
    ...
    useEffect(function () {
        ...
        var scene = new sprite.Scene($div.current, sceneProps);
        var container = Reconciler.createContainer(scene);
        Reconciler.updateContainer(props.children, container, _this);
    }, []);
    return React.createElement("div", { style: style, ref: $div });
}

export { Reconciler, Scene };
